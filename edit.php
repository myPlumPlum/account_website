                ...
                <div class="card mb-2" style="width: 36rem;">
                    <div class="card-body">
                        ...
                        <form action="process.php" method="POST">
                            <?php
                              $sql_edit = "SELECT * FROM user_admin WHERE id = :id";
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" class="form-control" name="FullyName" value="<?php echo $row_edit['FullyName']; ?>">
                            </div>
                            <input type="hidden" name="id" value="<?php echo $row_edit['id']; ?>">
                            <input type="hidden" name="passwordID" value="<?php echo $row_edit['passwordID']; ?>">
                            <input type="hidden" name="bank_name" value="<?php echo $row_edit['bank_name']; ?>">
                            <input type="hidden" name="acc_number" value="<?php echo $row_edit['acc_number']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="userID" value="<?php echo $row_edit['userID']; ?>">
                            </div>
                            <!-- <div class="form-group">
                                <label for="exampleInputEmail1">รหัสผ่าน</label>
                                <input type="email" class="form-control" placeholder="กรุณาระบุรหัสผ่านใหม่">
                            </div> -->
                            <button type="submit" class="btn btn-success btn-lg my-2" style="width: 100%;" name="edit" value="edit">ยืนยันข้อมูล</button>
                        </form>
                        </p>
                        <a href="user.php" class="card-link">ยกเลิกแก้ไขข้อมูล</a>
                    </div>
                </div>
            </div>
