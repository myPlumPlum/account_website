  ...
  <div class="row">
      <div class="col" style="background: #543d00;text-align: center;">
          ...
          <i class="bi bi-filetype-pdf"></i>
            <h3><b style="color: #fff;">คู่มือ</b></h3> <br>
            <p style="color: #fff;"><a href="Manual/M1.pdf"><img src="icon/filetype-pdf.svg"></a> คู่มือการใช้งานโปรแกรมการเงิน</p> <br>
            <p style="color: #fff;"><a href="Manual/M1.pdf"><img src="icon/filetype-pdf.svg"></a> คู่มือการใช้งานโปรแกรมการเงิน</p>
      </div>
    </div>
  </div>
